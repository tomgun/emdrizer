...
## Summary
- What are we building: A simple web/mobile app for self-administered EMDR: moving eye target (KITT-style and therapist-finger views), adjustable speed with research-based presets, and screen-size–dependent instructions.
- Primary platform: web (responsive); mobile-friendly (PWA or responsive).

## Agentic framework (AI environments)
- AI Environments: cursor, claude

## Languages & runtimes
- Language(s): TypeScript
- Runtime(s): Browser; Node 20 LTS for tooling
- Specific versions: Node 20.x; TypeScript 5.x (set at scaffold)

## Frameworks & libraries
- App framework: Vite
- UI framework (if any): React
- Specific versions: Vite 6.x, React 19.x (set at scaffold)
...
- **Copyright**: 2026 (update with your name/org)
- **Compatible Dependencies**: MIT, Apache 2.0, BSD, LGPL (dynamic linking)
- **Incompatible Dependencies**: GPL, AGPL — agent must avoid these
- **Asset Licensing**: See `assets/ATTRIBUTION.md` for any external assets (e.g. therapist finger image)
...
## Testing (required)
- Unit test framework: Vitest (Vite-native)
- Integration/E2E (optional): Playwright later if needed
- Test commands:
  - Unit: `npm test`
  - Integration: N/A
  - E2E: N/A
